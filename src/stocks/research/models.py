"""Model protocol and model manifest.

A model is an interchangeable implementation behind a protocol, not the
architecture. ``DeterministicBaseline`` is the deterministic ranking baseline
used to validate the pipeline without any fitted parameters.
"""
