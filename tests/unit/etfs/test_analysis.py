...
from src.etfs.research.analysis import assess_stability, summarize_result
from src.etfs.research.walk_forward import build_walk_forward_folds, run_walk_forward
...
class TestAnalysis:
    ...
    def test_stability_report_must_match_invariant_set(self) -> None:
        from src.etfs.research.analysis import StabilityReport
