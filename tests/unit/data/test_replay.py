...
def test_materialize_gold_window_silver_root_bounded_branch(tmp_path, monkeypatch) -> None:
    ...
    tables = {
        ...
        SilverTable.SECURITY_MASTER: pl.DataFrame({'instrument_id': ['KRX:1'], 'ticker': ['1'], 'company_id': ['C1'], 'market': ['KOSPI'], 'sector': ['Technology'], 'listing_date': [datetime(2010, 1, 1, tzinfo=UTC)], 'delisting_date': [None], 'share_class': ['common'], 'status': ['listed'], 'valid_from': [sessions[0]], 'valid_to': [sessions[-1]], 'available_at': [sessions[0]], 'source_hash': [src_hash]}),
        ...
        SilverTable.CORPORATE_ACTIONS: pl.DataFrame({'instrument_id': ['KRX:1'], 'effective_date': [sessions[0]], 'coverage_end': [sessions[0]], 'action_id': ['a1'], 'type': ['dividend'], 'factor': [1.0], 'cash_amount': [0.0], 'source': ['KRX'], 'available_at': [sessions[0]], 'source_hash': [src_hash], 'share_listing_date': [None], 'share_delta': [None], 'evidence_status': ['verified'], 'evidence_reason': [None]}),
        ...
        SilverTable.LIFECYCLE_EVENTS: pl.DataFrame({'instrument_id': ['KRX:999999'], 'ticker': ['999999'], 'event_type': ['delisting'], 'published_at': [sessions[0]], 'available_at': [sessions[0]], 'cleanup_start': [sessions[0]], 'cleanup_end': [sessions[0]], 'last_tradable_session': [sessions[0]], 'delisting_date': [sessions[0].date()], 'cash_settlement_per_share': [None], 'source_url': ['https://dart.fss.or.kr/x'], 'source_hash': [src_hash], 'evidence_status': ['unresolved'], 'evidence_reason': ['missing_terms'], 'source_provider': ['opendart'], 'document_receipt_no': [None], 'document_sha256': [None], 'resolution_kind': ['unresolved'], 'successor_instrument_id': [None], 'lifecycle_event_id': ['evt-999999'], 'source_security_id': ['KR7999999007'], 'successor_allocations_json': [None], 'successor_delivery_date': [None]}),
    }
    now = datetime.now(UTC)
...
def _build_eligible_silver_fixture(n_sessions: int = 255) -> tuple[tuple, dict]:
    ...
    tables = {
        ...
        SilverTable.FINANCIAL_FACTS: pl.DataFrame({'company_id': ['C1'], 'fiscal_period': ['2023Q4'], 'filing_id': ['f1'], 'fact': ['sales'], 'published_at': [sessions[0]], 'available_at': [sessions[0]], 'value': [1e9], 'unit': ['KRW'], 'consolidated': [True], 'restatement_id': ['r0'], 'source_hash': [src_hash], 'source_kind': ['opendart_standard'], 'mapping_version': ['v1'], 'raw_document_hash': [None]}),
        SilverTable.CORPORATE_ACTIONS: pl.DataFrame({'instrument_id': ['KRX:1'], 'effective_date': [sessions[0]], 'coverage_end': [sessions[-1]], 'action_id': ['a1'], 'type': ['dividend'], 'factor': [1.0], 'cash_amount': [0.0], 'source': ['KRX'], 'available_at': [sessions[0]], 'source_hash': [src_hash], 'share_listing_date': [None], 'share_delta': [None], 'evidence_status': ['verified'], 'evidence_reason': [None]}),
        SilverTable.DISCLOSURES: pl.DataFrame({'company_id': ['C1'], 'filing_id': ['f1'], 'filing_type': ['annual'], 'published_at': [sessions[0]], 'available_at': [sessions[0]], 'correction_of': [None], 'source_hash': [src_hash]}),
        SilverTable.HISTORICAL_COSTS: pl.DataFrame({'market': ['KOSPI'], 'effective_date': [sessions[0]], 'cost_kind': ['commission'], 'rule_id': ['r1'], 'value': [0.00015], 'available_at': [sessions[0]], 'source_hash': [src_hash]}),
        SilverTable.LIFECYCLE_EVENTS: pl.DataFrame({'instrument_id': ['KRX:999999'], 'ticker': ['999999'], 'event_type': ['delisting'], 'published_at': [sessions[0]], 'available_at': [sessions[0]], 'cleanup_start': [sessions[0]], 'cleanup_end': [sessions[0]], 'last_tradable_session': [sessions[0]], 'delisting_date': [sessions[0].date()], 'cash_settlement_per_share': [None], 'source_url': ['https://dart.fss.or.kr/x'], 'source_hash': [src_hash], 'evidence_status': ['unresolved'], 'evidence_reason': ['missing_terms'], 'source_provider': ['opendart'], 'document_receipt_no': [None], 'document_sha256': [None], 'resolution_kind': ['unresolved'], 'successor_instrument_id': [None], 'lifecycle_event_id': ['evt-999999'], 'source_security_id': ['KR7999999007'], 'successor_allocations_json': [None], 'successor_delivery_date': [None]}),
    }
