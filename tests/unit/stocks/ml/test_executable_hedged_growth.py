...
def test_build_executable_hedge_evidence_aligns_exact_intervals() -> None:
    ...
    from src.stocks.ml.hedge_sleeve import build_executable_hedge_evidence
...
def test_executable_hedged_certificate_uses_combined_account_path() -> None:
    ...
    from src.stocks.ml.contracts import AccountCertificationSettings, CompoundingCertificationSettings, HedgeExecutionEvidence, SmallCapitalPlanSettings
    from src.stocks.ml.hedge_sleeve import certify_executable_hedged_growth_route
    from src.stocks.ml.horizons import GrowthRouteEvidence
...
def test_synthetic_hedge_projection_never_becomes_deployable() -> None:
    from src.stocks.ml.contracts import AccountCertificationSettings, CompoundingCertificationSettings, SmallCapitalPlanSettings
    from src.stocks.ml.horizons import GrowthRouteEvidence
