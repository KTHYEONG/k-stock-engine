...
def test_terminal_obs_01_no_mem_or_scratch_side_effect(
    ...
    import src.stocks.ml.fitting as fitting_module
    from src.stocks.ml.contracts import NetAlphaTrainingRequest
    from src.stocks.ml.fitting import OofCache
    from src.stocks.ml.fitting import default_oof_cache_base
    from src.stocks.ml.training import _default_oof_cache_base as training_cache_base
    from src.stocks.ml.training import _execution_replay_context, _OofCache
