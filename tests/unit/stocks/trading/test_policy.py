...
def test_risk_policy_fingerprint_is_compatible_across_import_paths() -> None:
    from src.stocks.trading.policy import StockRiskPolicy as PolicyPolicy
    from src.stocks.trading.portfolio_constructor import StockRiskPolicy as PortfolioPolicy
    from src.stocks.trading.policy import stock_risk_policy_fingerprint as policy_fp
    from src.stocks.trading.portfolio_constructor import stock_risk_policy_fingerprint as portfolio_fp
