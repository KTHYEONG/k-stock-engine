...
from legacy.stocks.workflows.trading_cycle import TradingCycleRequest, run_trading_cycle
...
def test_full_5y_supervised_05_terminal_evidence() -> None:
    ...
    from legacy.stocks.paths import PROJECT_ROOT, RUN_DIAGNOSTIC_ROOT
...
def _run_isolated_full_matrix(*, max_rss_mib: int | None) -> None:
    ...
    from legacy.stocks.paths import PROJECT_ROOT, STOCK_ARTIFACT_ROOT
