...
from legacy.stocks.ml.fitting import OofCache, OofFitRequest, fit_horizon_oof
from legacy.stocks.ml.preparation import prepare_folds, prepare_horizon_labels, prepare_matrix_from_frame
...
def _get_route_calibration_ledger():
    try:
        from legacy.stocks.ml.model_selection import route_calibration_ledger as _rcl

        return _rcl
    except Exception:
        from legacy.stocks.ml.training import route_calibration_ledger as _rcl2
