def test_model_selection_screening_leaf_preserves_chronological_sampling() -> None:
    import polars as pl
    from legacy.stocks.ml import model_selection_screening as screening
    from legacy.stocks.ml import model_selection_study as study
...
def test_model_selection_compatibility_monkeypatch_reaches_leaf(monkeypatch) -> None:
    from legacy.stocks.ml import model_selection as facade
    from legacy.stocks.ml import model_selection_study as study
