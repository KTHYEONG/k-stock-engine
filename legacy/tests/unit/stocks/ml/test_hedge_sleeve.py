...
from legacy.stocks.ml.contracts import DEFAULT_CANDIDATE_REBALANCE_FREQUENCY_SESSIONS
from legacy.stocks.ml.hedge_sleeve import (
    _vol_managed_scales,
...
def test_executable_hedge_requires_parallel_cash_safe_proxy_series() -> None:
    ...
    from legacy.stocks.ml.contracts import HedgeDeploymentEvidence, SmallCapitalPlanSettings
    from legacy.stocks.ml.hedge_sleeve import project_executable_hedged_route
...
def test_hedge_execution_evidence_rejects_static_lot_and_missing_tax_model() -> None:
    ...
    from legacy.stocks.ml.contracts import HedgeExecutionEvidence, SmallCapitalPlanSettings
    from legacy.stocks.ml.hedge_sleeve import certify_small_capital_hedge_execution
