...
from legacy.stocks.research.calibration_schedule import (
...
def test_route_gatekeeping_demotes_cell_holm() -> None:
    ...
    from legacy.stocks.ml.horizons import select_horizons
...
def test_bucket_lower_bound_memoized() -> None:
    ...
    import legacy.stocks.research.calibration_schedule as cs
...
def test_parallel_horizons_merge_deterministically() -> None:
    ...
    from legacy.stocks.ml.training import _run_ordered_with_workers
