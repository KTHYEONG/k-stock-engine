...
def test_bootstrap_parity_01_pooled_matches_materialized_reference() -> None:
    ...
    from legacy.stocks.ml.horizons import _segment_block_length, _cohort_bootstrap
...
class TestBenchmarkReconciliationReason:
    ...
    def _route_and_discovery(n_panel_sessions: int, growth_length: int):
        ...
        from legacy.stocks.ml.horizons import HorizonOOFEvidence as _Evidence
        from legacy.stocks.ml.training import HorizonDiscovery
        ...
        from legacy.stocks.ml.horizons import GrowthRouteEvidence as _Route
