...
from legacy.stocks.paths import STOCK_ARTIFACT_ROOT, STOCK_DATASET_ROOT, STOCK_FEATURE_SOURCE_ROOT
from legacy.stocks.cli import curate
from legacy.stocks.cli.curate import main
...
def test_train_and_simulate_clis_default_to_canonical_roots() -> None:
    ...
    from legacy.stocks.cli import simulate, train
