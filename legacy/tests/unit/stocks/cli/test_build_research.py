...
from legacy.stocks.cli import build_research
...
def test_build_research_materializes_without_active_policy_mutation(monkeypatch, tmp_path) -> None:
    ...
    from legacy.stocks.data.materialization import NetAlphaMaterializationRequest, NetAlphaMaterializationResult
    ...
    monkeypatch.setattr("legacy.stocks.cli.build_research.materialize_net_alpha_snapshot", fake_materialize)
    monkeypatch.setattr("legacy.stocks.data.materialization.materialize_net_alpha_snapshot", fake_materialize)
