...
from legacy.stocks.ml.features import build_model_features, stock_net_alpha_v1_roles
...
def test_execution_frontier_replay_policy_and_no_trade_gate() -> None:
    ...
    """
    from legacy.stocks.ml.horizons import HorizonOOFEvidence, select_horizons
...
def test_rawnet_lgbm_04_training_dispatch_fail_closed(monkeypatch) -> None:
    ...
    import legacy.stocks.ml.economic_research as economic_research_module
    from legacy.stocks.ml.contracts import ELASTIC_NET_FAMILY
    from legacy.stocks.ml.training import _fit_oof
...
def test_rawnet_lgbm_05_cli_family_wiring() -> None:
    ...
    from legacy.stocks.cli.train import _build_training_request
    from legacy.stocks.ml.contracts import ELASTIC_NET_FAMILY
...
def test_cadence_decision_monotone_pure_kernel() -> None:
    ...
    from legacy.stocks.ml.training import _cadence_decision_sessions
