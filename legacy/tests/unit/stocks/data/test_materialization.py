...
def test_materialization_uses_one_request_type() -> None:  # noqa: N802
    from legacy.stocks.data.materialization import NetAlphaMaterializationRequest as MatRequest  # noqa: N812
    from legacy.stocks.data.research_v2 import NetAlphaMaterializationRequest as V2Request  # noqa: N812
    from legacy.stocks.data.materialization import materialize_net_alpha_snapshot as MatFunc  # noqa: N812
    from legacy.stocks.data.research_v2 import materialize_net_alpha_snapshot as V2Func  # noqa: N812
