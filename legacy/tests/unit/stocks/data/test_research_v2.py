...
from legacy.stocks.data.contracts import CoverageRange, ResearchWindows, TimingConvention
...
from legacy.stocks.data.research_v2 import (
...
def test_materialization_uses_projection() -> None:
    ...
    from legacy.stocks.data.research_v2 import NetAlphaMaterializationRequest
...
class TestMaterializeSnapshot:
    def test_materializes_and_composes(self, tmp_path) -> None:
        ...
        from legacy.stocks.data.catalog import SnapshotResolver
