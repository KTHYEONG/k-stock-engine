...
from legacy.stocks.data.feature_contracts import (
    DuplicateRule,
    FeatureContractBook,
...
def test_ALPHA_ARCH_03_PIT_LINEAGE() -> None:
    ...
    from legacy.stocks.ml.features import stock_net_alpha_v2_contract_book, stock_net_alpha_v2_semantic_contracts
    import polars as pl
    ...
    from legacy.stocks.data.feature_contracts import make_feature_contract
