...
def test_SCENARIO_SMALL_ACCOUNT_LOT_03_HARD_TARGET_EXECUTION():
    ...
    from legacy.stocks.backtesting.engine import StockBacktester, BacktestRequest, ArtifactSchedule, ArtifactSlot
    from src.execution.domain.intents import TradeIntent
    from src.core.instruments import Instrument, AssetKind
    from src.core.portfolio import PortfolioSnapshot
    from legacy.stocks.workflows.trading_cycle import TradingCycleResult, CycleStatus
    from datetime import UTC, datetime
    import tempfile
    from pathlib import Path
