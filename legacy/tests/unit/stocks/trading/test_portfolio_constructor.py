...
def test_prepared_allocations_match_reference_constructor() -> None:
    ...
    from legacy.stocks.trading.allocation_policy import rank_stock_candidate_indices
    from legacy.stocks.trading.portfolio_constructor import (
...
def test_economic_entry_rank_overrides_raw_score() -> None:
    ...
    from legacy.stocks.trading.portfolio_constructor import _economic_rank_values
...
def test_prepared_reference_economic_rank_parity() -> None:
    ...
    from legacy.stocks.trading.portfolio_constructor import _SESSION_COLUMN
...
def test_waterfill_redistributes_capacity() -> None:
    ...
    """
    from legacy.stocks.trading.portfolio_constructor import _risk_balanced_waterfill
...
def test_sparse_turnover_budget() -> None:
    ...
    """
    from legacy.stocks.trading.portfolio_constructor import CompoundingPolicyConfig
...
class TestSparseRetainedRewaterfill:
    ...
    def test_SPARSE_REWATERFILL_01_RETAINED_TARGET_REFRESHED(self) -> None:
        ...
        from legacy.stocks.trading.portfolio_constructor import _retained_target
...
def test_SCENARIO_SMALL_ACCOUNT_LOT_01_WATERFILL_CONSTRAINTS():
    ...
    from src.core.instruments import AssetKind, Instrument
    from src.core.portfolio import PortfolioSnapshot
    from legacy.stocks.trading.portfolio_constructor import LotSizingConfig, StockRiskPolicy, construct_target_allocations
    import polars as pl
    from datetime import UTC, datetime, timedelta
...
def test_SCENARIO_SMALL_ACCOUNT_LOT_02_DISABLED_PARITY():
    ...
    from src.core.instruments import AssetKind, Instrument
    from src.core.portfolio import PortfolioSnapshot
    from legacy.stocks.trading.portfolio_constructor import LotSizingConfig, StockRiskPolicy, construct_target_allocations, PreparedAllocationMarket, construct_target_allocations_prepared
    import polars as pl
    from datetime import UTC, datetime, timedelta
...
def test_default_hard_bound_profiles_remain_allocation_compatible():
    ...
    from legacy.stocks.trading.portfolio_constructor import construct_target_allocations, StockRiskPolicy
...
def test_economic_gate_masks_distinguish_finite_mean_from_lower_bound() -> None:
    import numpy as np
    from legacy.stocks.trading.portfolio_constructor import economic_gate_masks
...
def test_portfolio_constructor_reexports_real_allocation_owner() -> None:
    from legacy.stocks.trading import portfolio_constructor
    from legacy.stocks.trading.portfolio_allocation import construct_target_allocations

    assert portfolio_constructor.construct_target_allocations is construct_target_allocations
    assert construct_target_allocations.__module__ == 'legacy.stocks.trading.portfolio_allocation'


def test_extracted_economic_gate_preserves_mode_specific_masks() -> None:
    import numpy as np

    from legacy.stocks.trading.portfolio_economic_gates import economic_gate_masks
