...
from legacy.stocks.trading.policy import ExecutionUtility, SizingMethod, StockRiskPolicy
from legacy.stocks.trading.transitions import TransitionEvidence
from legacy.stocks.trading.allocation import AllocationDecision
from legacy.stocks.trading.portfolio_constructor import stock_risk_policy_fingerprint
...
class TestStockRiskPolicyReExport:
    ...
    def test_import_from_policy(self) -> None:
        from legacy.stocks.trading.policy import StockRiskPolicy as policy_type
