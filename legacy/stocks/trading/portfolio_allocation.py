...
from legacy.stocks.trading.policy import (  # canonical ownership
    CompoundingPolicyConfig as _PolicyCompoundingConfig,
)
from legacy.stocks.trading.policy import (
...
from legacy.stocks.trading.portfolio_market import PreparedAllocationMarket as _LeafPreparedAllocationMarket
