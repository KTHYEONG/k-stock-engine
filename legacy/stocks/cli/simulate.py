...
from legacy.stocks.cli.contracts import parse_simulation_command
from legacy.stocks.config.research import CanonicalResearchProfile, resolve_simulation_request
from legacy.stocks.data.active import resolve_active_research_data
...
def main(args: list[str] | None = None) -> int:
    ...
    try:
        ...
        from legacy.stocks.data.costs import load_cost_evidence as _load
