...
if TYPE_CHECKING:
    ...
    from legacy.stocks.ml.models import ElasticPathResult
...
def _fit_single_weighted_elastic(
    ...
    *,
    ...
    from legacy.stocks.ml.models import ELASTIC_DESIGN_CHUNK_ROWS, prepare_indexed_elastic_design
...
def _predict_rows(
    ...
    from legacy.stocks.ml.models import ELASTIC_DESIGN_CHUNK_ROWS
