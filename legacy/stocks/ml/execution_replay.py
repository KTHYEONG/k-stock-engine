...
from legacy.stocks.ml.replay_aggregation import (
...
from legacy.stocks.ml.telemetry import current_rss_mib as _telemetry_current_rss_mib
...
try:
    from legacy.stocks.ml.return_transfer import build_prequential_transition_ledger  # noqa: F401
except Exception:
    build_prequential_transition_ledger = None  # type: ignore
from legacy.stocks.workflows.trading_cycle import (
    CycleFrameCache,
    TradingCycleRequest,
    TradingCycleResult,
...
def run_executable_overlay_replay(request: ExecutionEquivalentReplayRequest, overlay: object) -> ExecutionReplayEvidence:
    ...
    from legacy.stocks.ml.contracts import ConversionWaterfallEvidence, ExecutableOverlayData
    from legacy.stocks.ml.wealth_transfer import merge_conversion_waterfalls, require_executable_overlay_data
...
def _execute_candidate_segment(
    ...
    from legacy.stocks.ml.wealth_transfer import ConversionWaterfallAccumulator
