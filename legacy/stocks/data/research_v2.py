...
from legacy.stocks.data.contracts import CoverageRange, ResearchWindows
from legacy.stocks.data.costs import krx_market_for_code, load_cost_evidence
from legacy.stocks.data.curation import (
...
from legacy.stocks.data.evidence import load_krx_calendar_snapshot
...
from legacy.stocks.data.outcome_open_bars import load_outcome_open_bar_evidence
from legacy.stocks.data.quality import KRXSessionCalendar
from legacy.stocks.data.repositories import ResearchDataRepository
from legacy.stocks.data.tradability_events import load_tradability_event_evidence
from legacy.stocks.domain.execution_policy import ExecutionOutcomePolicy
from legacy.stocks.ml.contracts import DEFAULT_CANDIDATE_HORIZON_SESSIONS
from legacy.stocks.ml.data import assess_outcome_readiness
from legacy.stocks.research.features import stock_alpha_v2_allowlist
...
def _re_read_net_alpha_features(
    ...
    from legacy.stocks.ml.contracts import CANONICAL_FEATURE_SET
...
def _materialize_net_alpha_snapshot_impl(
    ...
    from legacy.stocks.data.evidence import load_corporate_action_snapshot
...
try:
    from legacy.stocks.data.materialization import (  # noqa: E402
        NetAlphaMaterializationRequest as _CanonicalRequest,
    )
    from legacy.stocks.data.materialization import (
