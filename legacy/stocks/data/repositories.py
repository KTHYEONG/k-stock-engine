...
from legacy.stocks.data.curation import BASE_PANEL_FEATURE_SET
from legacy.stocks.data.feature_contracts import feature_contract_book_from_allowlist
from legacy.stocks.data.labels import LABEL_FEATURE_SET
from legacy.stocks.ml.contracts import CANONICAL_FEATURE_SET, OUTCOME_STATUS_COLUMN
from legacy.stocks.ml.labels import HORIZON_COLUMN, OUTCOME_STATUS_DATASET_SUFFIX
...
class ResearchDataRepository:
    ...
    def _validate_status_spine(
        ...
        *,
        ...
        """
        from legacy.stocks.ml.contracts import OUTCOME_STATUS_VOCABULARY
