...
from legacy.stocks.research.artifacts import ModelArtifactRegistry, PredictionRequest
from legacy.stocks.research.datasets import research_eligible_frame, validate_stock_rows_available
from legacy.stocks.research.features import build_features, phase1_allowlist
...
try:
    from legacy.stocks.trading.return_transfer_planner import plan_return_transfer_transition  # noqa: F401
except Exception:
...
def plan_prepared_scored_cycle(
    ...
    from legacy.stocks.trading.portfolio_constructor import construct_target_allocations_prepared_with_evidence
...
def _drop_label_columns(frame: pl.DataFrame) -> pl.DataFrame:
    ...
    from legacy.stocks.research.labels import (
